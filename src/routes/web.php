...
use GMJ\LaravelBlock2Gallery\Http\Controllers\BlockController;
use GMJ\LaravelBlock2Gallery\Http\Controllers\ConfigController;
use Illuminate\Support\Facades\Route;

Route::group([
    "middleware" => ["web", "auth"],
    "prefix" => "admin/element/{element_id}/gmj/laravel_block2_gallery",
    "as" => "LaravelBlock2Gallery."
], function () {
